        ...
        wso2Extend.prototype = {
            ...
            _constructor: function(){
                ...
                $('.dataTable.list-table').closest('.dataTables_wrapper').find('.dataTablesTop .dataTables_toolbar').html('' +
                    ...
                    '<li class="deselect-all-btn" style="display:none;"><button data-click-event="toggle-deselect-all" class="btn btn-default btn-primary">Deselect All</li>' +
               ...
               $('.dataTables_wrapper').on('click', '[data-click-event=toggle-select]', function () {
                ...
                $('.dataTables_wrapper').off('click', '[data-click-event=toggle-deselect-all]');
                $('.dataTables_wrapper').on('click', '[data-click-event=toggle-deselect-all]', function () {
                    $('#action').val("select-list");
                });
                ...
                $('body').on('click', '[data-type=selectable]', function() {
                    ...
                    var sAllBtn = $("button[data-click-event='toggle-select-all']");
                    if (selected) {
